...
<template>
  <div>
    <div v-if="coinInfo && coinInfo.name" class="bg-base-100 rounded shadow">
      <div class="grid grid-cols-2 md:grid-cols-3 p-4">
        <div class="col-span-2 md:col-span-1">
          <div>
          <div class="text-xl font-semibold text-main float-left">
            {{ coinInfo.name }} (<span class="uppercase">{{
              coinInfo.symbol
            }}</span>)
          </div>
          <div class="text-xl font-semibold mt-2 mb-2 float-right">
            {{ $t('index.rank') }}:
            ...
            <div class="dropdown dropdown-hover w-full">
              <label>
                <div
                  ...
                  <div class="text-right bg-gray-100 dark:bg-[#384059]" >
              ...
              <div class="dropdown-content pt-1" style="z-index: 999">
            ...
            <div>
              ...
              <table className="table">
                <tbody>
                  <tr>
                    <td>Market Cap</td>
                    <td class="text-right">$1,150,736,830</td>
                  </tr>
                  <tr>
    ...
    <div v-if="blockchain.supportModule('governance')" class="bg-base-100 rounded mt-4 shadow">
      ...
      <div class="grid grid-cols-1 gap-4 md:!grid-cols-3 lg:!grid-cols-6 mt-4">
      <div v-for="(item, key) in store.foundationStats" :key="key">
        <CardStatisticsVertical v-bind="item" />
      </div>
    </div>
    </div>
